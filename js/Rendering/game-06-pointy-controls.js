(function () {
	...
	function update() {
		...
		// get the thing's side vector
		var sideVector = getSideVector(thingMesh);
		sideVector.multiplyScalar(controller.strafeLeftRight() * moveSpeed);
		...
		redDir.addVectors(forwardVector, sideVector);
		updateDebugArrow(redArrow, thingMesh.position, redDir, 10);
		redArrow.position.add(new THREE.Vector3(0,1,0));
